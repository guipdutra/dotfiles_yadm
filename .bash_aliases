...
alias get_pods_k12='kubectl get pods -n prod'
alias kub='kubectl'
alias serenity='/usr/local/share/serenity && ./serenity'
alias serenity="cd /usr/local/share/serenity && ./serenity"
alias serenity="cd /usr/local/share/serenity && sudo ./serenity"
alias serenity="cd /usr/local/share/serenity && ./serenity"
alias solu_staging="gcloud container clusters get-credentials sets-stg --zone us-central1-a --project jeyloo-185311"
alias solu_prod="gcloud container clusters get-credentials sets-prod --zone us-central1-a --project jeyloo-185311"
alias gbr="git branch"
alias vim="nvim"
alias todo="vim ~/Projects/todo"
